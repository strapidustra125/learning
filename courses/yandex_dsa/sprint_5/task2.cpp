 ...
 * -- ВРЕМЕННАЯ СЛОЖНОСТЬ --
 *
 *  Временная сложность в худшем случае - когда высота дерева равна 
 * количеству узлов, т.е. O(n), где n - число узлов в дереве.
 *
 * -- ПРОСТРАНСТВЕННАЯ СЛОЖНОСТЬ --
 *
 *  Cтек вызовов рекурсии - O(n), где n - число узлов в дереве.
 *
 *************************************************************************/
